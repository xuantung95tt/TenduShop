                ...
                c => new
                    {
                        ...
                        Alias = c.String(nullable: false, maxLength: 500, unicode: false),
                        CategoryID = c.Int(nullable: false),
                        Image = c.String(maxLength: 500),
                        MoreImages = c.String(storeType: "xml"),
                        Price = c.Decimal(nullable: false, precision: 18, scale: 2),
                        PromotionPrice = c.Decimal(precision: 18, scale: 2),
                        Warranty = c.Decimal(precision: 18, scale: 2),
                ...
                c => new
                    {
                        ...
                        ValueString = c.String(maxLength: 500),
                        ValueInt = c.Int(),
                    })
                .PrimaryKey(t => t.ID);
                ...
                c => new
                    {
                        ...
                        IPAddress = c.String(nullable: false, maxLength: 500),
                    })
                .PrimaryKey(t => t.ID);
